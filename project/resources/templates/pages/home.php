<div id="this-carousel-id" class="carousel slide"><!-- class of slide for animation -->
  <div class="carousel-inner">
    ...
    <?php foreach ($polls as $poll): ?>
      ...
      <?php if($index == 0 && $poll->isClosed == 0): ?>
        <div class="item active">
      <?php elseif($poll->isClosed == 0):  ?>
        <div class="item">
      <?php endif ?>
...
<div class="container siteMap col-lg-12">
  <div class="siteMapInf col-lg-6 col-md-6 col-sm-12 col-xs-12">
    ...
    <p class="siteMapDescription col-lg-12">You can create as many polls as
...
<div class="container siteMap col-lg-12">
  ...
  <div class="siteMapInf col-lg-6 col-md-6 col-sm-12 col-xs-12">
    ...
    delete and see the actual results of your polls.</p>
  </div>
...
<div class="container siteMap col-lg-12">
  <div class="siteMapInf col-lg-6 col-md-6 col-sm-12 col-xs-12">
    <h3 class="siteMapTitle col-lg-12">Vote on polls. </h3>
    <p class="siteMapDescription col-lg-12">You can give your opinion: on your own polls,
    on private pools which you have been invited to and also on public polls.</p>
  </div>
